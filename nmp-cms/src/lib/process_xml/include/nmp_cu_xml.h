/********************************************************************
 * nmp_cu_xml.h  - deal xml of cu, parse and create xml
...
int
nmp_create_cu_login(xmlDocPtr doc, NmpMsgInfo *sys_msg);
...
NmpMsgInfo *
nmp_parse_cu_login_resp(xmlDocPtr doc,xmlNodePtr cur, char *cmd);
int
...
NmpMsgInfo *
nmp_parse_get_tw_auth_info(xmlDocPtr doc , xmlNodePtr cur, char *cmd);

int
nmp_create_get_tw_auth_info_resp(xmlDocPtr doc, NmpMsgInfo *sys_msg);

NmpMsgInfo *
nmp_parse_cu_alarm_link_io(xmlDocPtr doc ,	xmlNodePtr cur, char *cmd);

int
nmp_create_cu_alarm_link_io_resp(xmlDocPtr doc, NmpMsgInfo *sys_msg);
