...
#define NMP_MODTW(o) \
	(G_TYPE_CHECK_INSTANCE_CAST((o), NMP_TYPE_MODTW, JpfModTw))
#define NMP_MODTW_CLASS(c) \
	(G_TYPE_CHECK_CLASS_CAST((c), NMP_TYPE_MODTW, JpfModTwClass))
#define NMP_MODTW_GET_CLASS(o) \
	(G_TYPE_INSTANCE_GET_CLASS((o), NMP_TYPE_MODTW, JpfModTwClass))
