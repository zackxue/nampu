 ...
 * nmp_event_request() will sleep, and will not be woken
...
NmpEventTable *nmp_event_table_new(gpointer owner);
void nmp_event_table_destroy(NmpEventTable *table);

/* send request, and wait */
gint nmp_event_request(NmpEventTable *t, NmpSysMsg **msg);

/* invoked by response giver */
gint nmp_event_response(NmpEventTable *table, NmpSysMsg *msg);
