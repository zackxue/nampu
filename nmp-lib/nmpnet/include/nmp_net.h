...
nmp_net *nmp_net_new(int loops);
void nmp_net_release(nmp_net *net);

void nmp_net_set_funcs(nmp_net *net, nmp_io_init_func init, nmp_io_fin_func fin);
...
nmp_netio_t *nmp_net_create_io(nmp_net *net, nmp_conn_t *conn,
	nmp_2proto_t *proto, nmp_io_est_func on_est, int *err);

nmp_netio_t *nmp_net_create_listen_io(nmp_net *net, nmp_conn_t *conn,
	nmp_2proto_t *proto, int *err);

nmp_netio_t *nmp_net_create_listen_io_2(nmp_net *net, struct sockaddr *sa,
	nmp_2proto_t *proto, int *err);
...
int nmp_net_kill_io(nmp_net *net, nmp_netio_t *net_io);
