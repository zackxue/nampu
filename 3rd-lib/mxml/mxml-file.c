...
/*
 *	Fixme:	 Replace isspace as iswspace (fangy 2008-7-11)
 */
					...
					/* I - Read function */
{
  ...
  */
  ...
  {
    if ((ch == '<' ||
         (iswspace(ch) && type != MXML_OPAQUE && type != MXML_CUSTOM)) &&
        bufptr > buffer)
    {
     /*
	...
	*/
	...
	break;
      ...
      bufptr     = buffer;
      whitespace = iswspace(ch) && type == MXML_TEXT;
	...
	*/
    ...
    else if (iswspace(ch) && type == MXML_TEXT)
      whitespace = 1;
    ...
    */
    ...
    if (ch == '<')
    {
      ...
      */
      ...
      while ((ch = (*getc_cb)(p, &encoding)) != EOF)
        if (iswspace(ch) || ch == '>' || (ch == '/' && bufptr > buffer))
	  break;
	else if (ch == '&')
	{
	...
	*/
    ...
    else if (type == MXML_OPAQUE || type == MXML_CUSTOM || !iswspace(ch))
    {
     /*
