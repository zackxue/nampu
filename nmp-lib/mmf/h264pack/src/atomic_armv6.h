...
typedef struct { volatile int counter; } _atomic_t;

static inline void _atomic_set(_atomic_t *v, int i)
{
	unsigned long tmp;
...
static inline int _atomic_add_return(int i, _atomic_t *v)
{
	unsigned long tmp;
	int result;
...
static inline int _atomic_sub_return(int i, _atomic_t *v)
{
	unsigned long tmp;
	int result;
...
#define _atomic_add(i, v)	(void) _atomic_add_return(i, v)
#define _atomic_inc(v)		(void) _atomic_add_return(1, v)
#define _atomic_sub(i, v)	(void) _atomic_sub_return(i, v)
#define _atomic_dec(v)		(void) _atomic_sub_return(1, v)
